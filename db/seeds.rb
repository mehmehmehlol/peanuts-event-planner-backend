...
c4 = Character.create(name: 'Peppermint Patty', nickname: 'Sir', personality: 'loyal, courageous, vulnerable at times', hobbies: 'playing sports, skating', image: 'https://www.peanuts.com/sites/default/files/pp-color.jpg')
